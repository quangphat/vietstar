...
function GetLocSigns(controlId, defaultValue = 0) {
    ...
    if (controlId == null)
        return;
    $(controlId).empty();
    $(controlId).append("<option value='0'>Chọn địa điểm</option>");
...
function GetLoanCities(controlId, defaultValue = 0) {
    ...
    if (controlId == null)
        return;
    $(controlId).empty();
    $(controlId).append("<option value='0'>Chọn tỉnh/thành</option>");
...
function GetLoanProducts(controlId, defaultValue = 0) {
    ...
    if (controlId == null)
        return;
    $(controlId).empty();
    $(controlId).append("<option value='0'>Chọn sản phẩm vay</option>");
